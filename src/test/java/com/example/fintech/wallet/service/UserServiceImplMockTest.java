...
class UserServiceImplMockTest {
    ...
    void testTransfer_success_withMockedDependencies() {
        ...
        // Simula el método transfer en UserServiceImpl (deberías tenerlo implementado)
        // Aquí solo mostramos cómo sería el test con mocks
    ...
    void testRefreshToken_success_withMockedDependencies() {
        ...
        // Simula el flujo del endpoint refresh
